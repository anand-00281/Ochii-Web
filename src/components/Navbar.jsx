...
function Navbar() {
  ...
  return (
    <div className='fixed z-[999] flex justify-between items-center w-full px-4 py-4 md:px-20 font-["Neue Montreal"] bg-zinc-900'>
      <div className="logo">
      ...
      <div className="links hidden md:flex gap-10 md:gap-20">
      ...
      {isOpen && (
        <div className="absolute top-16 left-0 w-full bg-zinc-900 flex flex-col items-center md:hidden transition-transform transform duration-300 ease-in-out">
          {["services", "our works", "About us", "Insights", "Contact"].map((item, index) => (
            <a key={index} className="text-lg capitalize font-light py-2 w-full text-center hover:bg-zinc-800 transition duration-200">
              {item}
            </a>
          ))}
        </div>
